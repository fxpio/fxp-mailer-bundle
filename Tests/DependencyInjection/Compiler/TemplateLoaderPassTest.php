 ...
 * @internal
 */
final class TemplateLoaderPassTest extends KernelTestCase
{
    /**
     * @var string
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->pass = new TemplateLoaderPass();
    }
    ...
    public function testProcessWithoutService(): void
    {
        ...
        $this->assertFalse($container->has('fxp_mailer.loader.template_layout_chain'));
        $this->assertFalse($container->has('fxp_mailer.loader.template_mail_chain'));
    }
